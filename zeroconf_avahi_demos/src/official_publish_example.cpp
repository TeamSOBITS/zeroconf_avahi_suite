/**
 * @file /zeroconf_avahi/src/bin/official_example.cpp
 *
...
static void create_services(AvahiClient *c) {
    ...
    if (avahi_entry_group_is_empty(group)) {
        ...
        if ((ret = avahi_entry_group_add_service(group, AVAHI_IF_UNSPEC, AVAHI_PROTO_UNSPEC, static_cast<AvahiPublishFlags>(0), name, "_ipp._tcp", NULL, NULL, 651, "test=blah", r, NULL)) < 0) {
        ...
        if ((ret = avahi_entry_group_add_service(group, AVAHI_IF_UNSPEC, AVAHI_PROTO_UNSPEC, static_cast<AvahiPublishFlags>(0), name, "_printer._tcp", NULL, NULL, 515, NULL)) < 0) {
        ...
        if ((ret = avahi_entry_group_add_service_subtype(group, AVAHI_IF_UNSPEC, AVAHI_PROTO_UNSPEC, static_cast<AvahiPublishFlags>(0), name, "_printer._tcp", NULL, "_magic._sub._printer._tcp") < 0)) {
